...
const Allevents = () => {
  return (
    <div className='max-w-[1200px] mx-auto relative  md:mx-5 sm:mx-3 overflow-auto  '>
      ...
      <div className='flex flex-wrap items-center gap-4 justify-between mt-[40px] relative md:space-y-5 '>
